...
initial_url = ["https://www.olx.pl/d/nieruchomosci/mieszkania/wynajem/sopot/",
               "https://www.olx.pl/d/nieruchomosci/mieszkania/wynajem/gdansk/"]

city_name = ["Sopot", "Gdansk"]

for city, city_n in zip (initial_url, city_name):
    ...
    def last_page():
        ...
        response_initial = requests.get(city)
    ...
    def load_flats_initial():
        ...
        for x in range(page, last_page()):
            ...
            response = requests.get(city + "?page=" + str(x))
    ...
    df.to_excel("output" + city_n + ".xlsx")
